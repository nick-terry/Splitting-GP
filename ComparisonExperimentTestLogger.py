...
import LocalGP_Kfold_Crossvalidation_Logger
import pandas as pd
...
def runExperimentWithKwargs(args):
    return LocalGP_Kfold_Crossvalidation_Logger.runCrossvalidationExperiment(args[0],**args[1])
...
def runExperimentSequential():
    ...
    for modelType,params in zip(modelTypes,paramsList):
        results = LocalGP_Kfold_Crossvalidation_Logger.runCrossvalidationExperiment(modelType, 
                                                                         params=params,
